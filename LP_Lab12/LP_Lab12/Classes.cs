...
namespace LP_Lab12
{
    ...
    class Printer
    {
        ...
        public void CreateTitle(string str, char symb)
        {
            str = str.PadLeft(str.Length+5, symb);
            Console.WriteLine(str.PadRight(str.Length+5, symb));
        }
    }
    ...
    partial class Developer
    {
        ...
        public void kek(int i) => Console.WriteLine(i);
    }
